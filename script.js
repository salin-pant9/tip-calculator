...
setTimeout(() => {
    ...
    document.getElementById("header").innerHTML=`<div id="header">Tip Calculator</div>`
},500);
setTimeout(()=> {
...
const doCal= () => {
    ...
    if(amount.value==="" || people.value===""){
        ...
        setTimeout(() => {
            ...
            document.getElementById('final').innerHTML = `<div id="final">Tip per person is : ${getAmount}</div>`
        },2000);
    }
